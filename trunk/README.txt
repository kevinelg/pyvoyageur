 ...
 = STRUCTURE DU DEPOT =
 ======================
Auteurs: Raphaël Guye et Jonathan Neuhaus
...
Pour chaque paire de trajet, on:
  ...
  * Une fois que l'on ne peut plus ajouter de villes ni à droite ni à gauche, on ajoute le reste des villes présents dans le trajet 1 aléatoirement
...
On s'arrête lorsque toutes les combinaisons ont été passés en revue.

Nous avons également implémenté un algorithme d'échange de villes ainsi que sa fonction de mesure du gain, mais les résultats ne sont pas concluants (temps plus long et résultat de mauvaise qualité)
...
ce qui correspond à population = 100 pour 50 villes / population = 200 pour 200 villes
...
ce qui correspond à pe2 = 100 pour 50 villes / pe2 =30 pour 300 villes
Si on remarque que pe2 < 10, on fixe pe2 = 10

 ===========
 = Listing =
 ===========
Donnee.pdf						Consignes du problème
...
> Documents
		...
		TSPchapter.pdf				Explications et tests de différents algorithmes (plus détaillé)
...
> Ressources
		...
		GuyeNeuhaus.py	notre implémentation du solveur du voyageur de commerce
